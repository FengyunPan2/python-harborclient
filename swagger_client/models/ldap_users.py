...
class LdapUsers(object):
    ...
    def __init__(self, ldap_username=None, ldap_realname=None, ldap_email=None):
        """
        LdapUsers - a model defined in Swagger
        """
    ...
    def ldap_username(self):
        """
        Gets the ldap_username of this LdapUsers.
        search ldap user name based on ldapconf.

        :return: The ldap_username of this LdapUsers.
        :rtype: str
        """
    ...
    def ldap_username(self, ldap_username):
        ...
        :param ldap_username: The ldap_username of this LdapUsers.
        :type: str
        """
    ...
    def ldap_realname(self):
        """
        Gets the ldap_realname of this LdapUsers.
        system will try to guess the user realname form \"uid\" or \"cn\" attribute.

        :return: The ldap_realname of this LdapUsers.
        :rtype: str
        """
    ...
    def ldap_realname(self, ldap_realname):
        ...
        :param ldap_realname: The ldap_realname of this LdapUsers.
        :type: str
        """
    ...
    def ldap_email(self):
        """
        Gets the ldap_email of this LdapUsers.
        system will try to guess the user email address form \"mail\" or \"email\" attribute.

        :return: The ldap_email of this LdapUsers.
        :rtype: str
        """
    ...
    def ldap_email(self, ldap_email):
        ...
        :param ldap_email: The ldap_email of this LdapUsers.
        :type: str
        """
